...
describe_recipe 'ibm_integration_bus::runtime' do
	...
	describe 'the install' do
		...
		it 'doesn\'t install toolkit components' do
			verify_no_toolkit_install("iib2user")
		end
	...
	describe 'the node setup' do
		...
		it 'sets up the standard node with admin security active' do
			verify_standard_secure("iib2user")
		end
		
		it 'creates no other nodes' do
			nodes_on_machine_are(["SSNODE"], "iib2user")
		end
